...
public class CommonBase {
   ...
   public void webTableContent(WebElement element) {
	   
	   	//To locate rows of table. 
	   	List < WebElement > rows_table = element.findElements(By.tagName("input"));
	   	//To calculate no of rows In table.
	   	for (int i = 0; i < rows_table.size(); i++) {
	   		celtext=rows_table.get(i).getAttribute("value");
	   		//System.out.println(celtext);
             if (celtext.contains("ups_GND")) {
	   			 rows_table.get(i).click();
			}
	   		
		}
   } 	
	   	public void webTableAnchor(WebElement element) {
	   		String getId=element.getAttribute("id");
	 	    String[]	delId = getId.split("item_");
	   	   //System.out.println(delId[1]);   
	   	   String dynamic = "//*[@id=\"item_".concat(delId[1]).concat("\"]/div/div[2]/div[3]/a[2]");
	   ...
	   /*	Iterator<WebElement> it1 = rows_table.iterator();
	   	while (it1.hasNext()) {
	   		celtext=it1.next().getAttribute("value");
	   		System.out.println(celtext);
	   		if (celtext.contains("ups_3DSinput")) {
	   			
				
			*/
				/*System.out.println(celtext + "input");
	   		List < WebElement > Columns_row = 	it1.next().findElements(By.tagName("td"));
	   		//int columns_count = Columns_row.size();
	   		//System.out.println("Number of cells In Row " + it1 + " are " + columns_count);
	   		Iterator<WebElement> it2 = Columns_row.iterator();
	   		while (it2.hasNext()) {
	   			List<WebElement> test = it2.next().findElements(By.tagName("input"));
	   			Iterator<WebElement> it = test.iterator();
		   		   while (it.hasNext()) {
		   			celtext=it.next().getAttribute("value");
		   					System.out.println(celtext + "input");
				}
			}
		}*/
	   	...
	   	for (int row = 0; row < rows_count; row++) {
	   	   ...
	   	   for (int column = 0; column < columns_count; column++) {
	   		   ...
	   		   List<WebElement> test = Columns_row.get(column).findElements(By.tagName("input"));
	   		   Iterator<WebElement> it = test.iterator();
	   		   while (it.hasNext()) {
	   			celtext=it.next().getAttribute("value");
	   					System.out.println(celtext + "input");
	   		   ...
	   		   for (int i = 0; i < test.size(); i++) {
	   			celtext = test.get(i).getAttribute("value");
	   			System.out.println(celtext + "input");
			}
	   	    if (row ==0 && column == 0 && celtext.isEmpty()) {
	   	    	System.out.println("null1");
				System.out.println(celtext+ " " + "Null");
				System.out.println("null");
				System.out.println(Columns_row.get(0).getAttribute("Value"));
			}else {
				System.out.println(celtext + "Else Null");
			}
	   	   }
	   	   System.out.println("-------------------------------------------------- ");
	...
	public void selDropDown(WebElement element, String data) {
		Select dropdown = new Select(element);
		dropdown.selectByVisibleText(data);
   	}	
	
	public void textAreaData(WebElement element, String data)throws Exception{
	...
	public void checkWishTitle() {
		if (driver.getTitle().contains("Wish List")) {
